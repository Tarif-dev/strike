            ...
            {user ? (
              ...
              <div className="space-x-3">
                ...
                <Link to="/auth/signup">
                  <Button
                    variant="outline"
                    className="border-cricket-lime text-cricket-lime hover:bg-cricket-medium-green"
                  >
                    Sign Up
                  </Button>
                </Link>
          ...
          <div className="space-y-4 animate-fade-in">
            {activeTab === "Matches" && (
              <>
                ...
                <h3 className="font-semibold text-cricket-lime">
                  Upcoming Matches
                </h3>
          ...
          <div className="mt-8 bg-cricket-medium-green rounded-xl overflow-hidden">
            <div className="bg-cricket-light-green p-4">
              <div className="flex justify-between items-center">
                ...
                <Link to="/leagues" className="text-sm text-cricket-lime">
                  View All
                </Link>
              </div>
            </div>
            <div className="p-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <Link to="/leagues/l1" className="text-cricket-lime">
                  Join Now
                </Link>
              </div>
            </div>
