      ...
      <section className="relative h-screen flex items-center">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            >
              Fantasy Cricket <span className="text-neon-green">Reimagined</span>
            </motion.h1>
            ...
            >
              Build your dream team. Make strategic plays.<br />
              <span className="text-neon-green font-semibold">Win big</span> with every match.
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-2">15M+</h3>
            ...
            >
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-2">₹10Cr</h3>
      ...
      <section className="py-24 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Why Players Choose Strike</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Experience fantasy cricket like never before with our innovative features
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-400">
                Real-time performance metrics and match insights to help you make winning decisions.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                AI-powered team suggestions and player form indicators based on historical data.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">Multiple Contests</h3>
              <p className="text-gray-400">
                Choose from a variety of contests including head-to-head, leagues and mega tournaments.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                Real-time score updates, player stats and match commentary as the action unfolds.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                Fast payment processing with multiple options and instant withdrawals for your winnings.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                Play across all cricket formats from T20s and ODIs to Test matches and domestic leagues.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Featured Matches</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Join these popular contests and put your fantasy skills to the test
            </p>
          </motion.div>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 text-right">138/4 (20)</p>
                    </div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    <div className="h-12 w-12 rounded-full bg-red-900/20 flex items-center justify-center mr-3 border border-red-800/30">
                      <img src="/team_logos/rcb.jpeg" alt="RCB" className="h-8 w-8" />
                    </div>
                    <div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Winners' Circle</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-300">
                "STRIKE's analytical tools gave me the edge to win my first major contest. The live updates and player form indicators were game-changers!"
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                "Won the mega contest during the IPL final! The team builder helped me make last-minute adjustments after the toss. The UI is so clean!"
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                "Started with just ₹100 and built it up to over 5 lakhs in 2 months! Love the private leagues where I compete with friends."
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <div className="relative bg-gunmetal-grey/50 backdrop-blur-xl border border-neon-green/20 rounded-3xl px-6 py-16 md:p-16 text-center">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Strike Big?</h2>
                <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10">
                  Join millions of cricket fans who are winning real cash daily. Sign up now to get a welcome bonus of ₹100!
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            <div>
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Fantasy Cricket Reimagined</p>
                </div>
              </div>
              <p className="text-gray-400 mb-6">
                The ultimate fantasy cricket platform where strategy meets rewards.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link to="/matches" className="hover:text-neon-green transition-colors">
                    Matches
                  </Link>
                </li>
                <li>
                  <Link to="/leaderboard" className="hover:text-neon-green transition-colors">
                    Leaderboard
                  </Link>
                </li>
                <li>
                  <Link to="/how-to-play" className="hover:text-neon-green transition-colors">
                    How to Play
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="hover:text-neon-green transition-colors">
                    About Us
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link to="/terms" className="hover:text-neon-green transition-colors">
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link to="/privacy" className="hover:text-neon-green transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link to="/fair-play" className="hover:text-neon-green transition-colors">
                    Fair Play Policy
                  </Link>
                </li>
                <li>
                  <Link to="/responsible-gaming" className="hover:text-neon-green transition-colors">
                    Responsible Gaming
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link to="/faq" className="hover:text-neon-green transition-colors">
                    FAQ
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/feedback" className="hover:text-neon-green transition-colors">
                    Feedback
                  </Link>
                </li>
              </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} STRIKE Fantasy Sports. All rights reserved.
            </p>
